...
One more thing to do is to put some more order into our game files. Right now all the code files are located in the same "root" folder of our project. This is Ok for very simple projects, however, 
